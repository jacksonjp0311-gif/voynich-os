...
RCC reports, README audits, release reports, and reorganization plans.
...
|---|---|
| Shell | outer |
| Meridian(s) | evidence, release, documentation |
| Sector | reports |
| Version / TTL | RCC-N-v1.7 / 180 days |
| Last verified | 2026-05-28 |
| Local role | RCC reports, README audits, release reports, and reorganization plans. |

## Evidence Surface

reports/rcc_nexus, reports/readme, reports/reorg
