...
Corpus, generated folio outputs, meaning/vector layers, ledgers, and manuscript states.
...
|---|---|
| Shell | inner |
| Meridian(s) | source, evidence, manuscript |
| Sector | corpus_outputs |
| Version / TTL | RCC-N-v1.7 / 180 days |
| Last verified | 2026-05-28 |
| Local role | Corpus, generated folio outputs, meaning/vector layers, ledgers, and manuscript states. |

## Evidence Surface

data/corpus, data/folio_outputs, data/meaning, data/ledger, data/manuscript_v12_0
