...
Existing Voynich OS processing engine surface.
...
|---|---|
| Shell | inner |
| Meridian(s) | runtime, manuscript |
| Sector | engine |
| Version / TTL | RCC-N-v1.7 / 180 days |
| Last verified | 2026-05-28 |
| Local role | Existing Voynich OS processing engine surface. |

## Evidence Surface

engine scripts and processing logic
