...
Audit, normalization, RCC, validation, and future pipeline scripts.
...
|---|---|
| Shell | middle |
| Meridian(s) | validation, runtime, agent |
| Sector | scripts |
| Version / TTL | RCC-N-v1.7 / 180 days |
| Last verified | 2026-05-28 |
| Local role | Audit, normalization, RCC, validation, and future pipeline scripts. |

## Evidence Surface

scripts/voynich_repo_audit.py, scripts/normalize_json_utf8.py, scripts/rcc
