...
Claim boundary, reproducibility, context, architecture, and reflection documents.
...
| Local role | Claim boundary, reproducibility, context, architecture, and reflection documents. |

## Evidence Surface

docs/CLAIM_BOUNDARY.md, docs/REPRODUCIBILITY.md, docs/context
